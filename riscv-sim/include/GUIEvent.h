...
struct SGUIKeyType{
    ...
    static const uint32_t QuestionMark;
    static const uint32_t Exclamation;
    static const uint32_t AtSymbol;
    static const uint32_t Ampersand;
    static const uint32_t Pound;
    static const uint32_t Dollar;
    static const uint32_t Percent;
    static const uint32_t Caret;
